...
(function() {
  ...
  _.last = function(array, n) {
    return n === undefined ? array[array.length -1] : array.slice (n > array.length ? array : array.length - n);
  };
  ...
  // Elements should be outputted as an array
  ...
  //Deleted double comment about _.pluck()
  ...
  _.invoke = function(collection, functionOrKey, args) {
      if(typeof functionOrKey == 'function') {
        ...
        return _.map(collection, function(value, args) {
  ...
  _.delay = function(func, wait) {
    var args = arguments;
    return setTimeout(function() {return func(args[2], args[3]);}, wait);
  };
